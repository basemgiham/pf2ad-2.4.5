...
/usr/sbin/pkg unlock pfSense-2.5.1
...
fetch -o /usr/local/pkg -q https://raw.githubusercontent.com/basemgiham/pf2ad-2.4.5/master-1/samba.inc
fetch -o /usr/local/pkg -q https://raw.githubusercontent.com/basemgiham/pf2ad-2.4.5/master-1/samba.xml
...
cd /usr/local/pkg
fetch -o - -q https://raw.githubusercontent.com/basemgiham/pf2ad-2.4.5/master-1/squid_winbind_auth.patch | patch -b -p0 -f
fetch -o /usr/local/pkg -q https://raw.githubusercontent.com/basemgiham/pf2ad-2.4.5/master-1/squid.inc
